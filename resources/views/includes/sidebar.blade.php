...
<div class="fixed bottom-0 z-10 h-screen ltr:border-r rtl:border-l vertical-menu rtl:right-0 ltr:left-0 top-[70px] bg-slate-50 border-gray-50 print:hidden dark:bg-zinc-800 dark:border-neutral-700">
    ...
    <div data-simplebar class="h-full">
        ...
        <div class="metismenu pb-10 pt-2.5" id="sidebar-menu">
            <!-- Left Menu Start -->
            <ul id="side-menu">
                <x-menu-item title="Menu" is-header="true" />

                <x-menu-item title="Dashboard" icon="home" link="{{ '/' }}" />

                <x-menu-item title="User Management" icon="users" link="{{ route('users') }}" />

                <x-menu-item title="Event Management" icon="calendar" :hasDropdown="true">
                    <x-submenu-item title="Events List" link="{{ route('events.list') }}" />
                    <x-submenu-item title="Create Event" link="{{ route('events.create') }}" />
                </x-menu-item>
            </ul>
            ...
            <div class="mx-6 my-12 text-center sidebar-alert">
                <div class="rounded card-body bg-primary bg-violet-50/50 dark:bg-zinc-700/60">
                    ...
                    <div class="mt-4">
                        <h5 class="mb-3 font-medium text-16 text-violet-500">Unlimited Access</h5>
